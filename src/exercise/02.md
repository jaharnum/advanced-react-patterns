...
* both Children (methods, not the prop) and cloneElement are listed by react.dev as potentially leading to fragile code
* simply mapping the children prop can be used instead of the children element
* can't figure out how to replace clone element with renderChildren - need to re-learn inline functions like this
