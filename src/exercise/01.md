...
* Tree shaking is used in JS to describe the removal of dead code. In modern apps, this is done using settings in module bundles. It relies on import and export statements to detect if code modules are being used between files. 
